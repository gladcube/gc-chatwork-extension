...
Main = {
  get google_auth(){
    var ref$;
    return (ref$ = this._google_auth) != null
      ? ref$
      : this._google_auth = new OAuth2("google", {
  ...
  get is_expired(){
    return this.google_auth.isAccessTokenExpired();
  },
  get token(){
    if (!this.is_expired) {
      return this.google_auth.getAccessToken();
    }
  },
  execute: function(){
