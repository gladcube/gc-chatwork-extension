...
Member = (function(){
  ...
  var prototype = Member.prototype, constructor = Member;
  Member.id = "od6";
  Member.key = "1_zUfUl2rg1rB_LSVAv7gUqMfzaxyv6_vbVw2zhkPRU0";
  Member.url = function(){
    return "https://spreadsheets.google.com/feeds/list/" + this.key + "/" + this.id + "/private/basic?oauth_token=" + Main.token + "&alt=json";
  };
  Member.fetch = function(){
    var this$ = this;
    return $.get(this.url(), function(res){
      return this$.instances = map(function(it){
  ...
  function Member(arg$){
    this.content = arg$.content.$t, this.title = arg$.title.$t;
  }
  Object.defineProperty(prototype, 'pieces', {
    get: function(){
      var ref$;
      return (ref$ = this._pieces) != null
        ? ref$
        : this._pieces = this.content.match(/\w+:[^,]+/g);
    },
    configurable: true,
    enumerable: true
  });
  ...
  Object.defineProperty(prototype, 'name_jp', {
    get: function(){
      return last(
      split(": ")(
      this.pieces[2]));
...
Main = {
  ...
  watch: function(){
    var this$ = this;
    return Object.observe(this, function(){
      if (this$.is_ready) {
        return this$.read();
      }
    });
  ...
  listen: function(){
    var this$ = this;
    return $("#_chatText").textcomplete([{
      match: /\B@([\-+\w]*)/,
      search: function(term, cb){
        return cb(
        filter(function(it){
          return it.title.indexOf(term) >= 0;
        })(
        this$.members));
      },
      template: function(it){
        return "<span class='member-name'>" + it.name_jp + "さん</span>";
      },
      replace: function(it){
        return "[To:" + it.id + "] " + it.name_jp + "さん ";
      },
      index: 1
    }]);
  }
